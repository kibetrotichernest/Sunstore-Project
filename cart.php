            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    ...
                    <?php if (empty($_SESSION['cart'])): ?>
                        ...
                        <a href="/sunstore-industries/product.php?view=all" class="btn btn-primary">
                            Continue Shopping
                        </a>
                    <?php else: ?>
                        <form method="POST" action="cart.php">
                            ...
                            <div class="d-flex justify-content-between">
                                <a href="/sunstore-industries/product.php?view=all" class="btn btn-outline-primary">
                                    Continue Shopping
                                </a>
                                <div>
                                    ...
                                    <a href="/Sunstore-Project/checkout.php" class="btn btn-success">
                                        Proceed to Checkout
                                    </a>
                                </div>
                            </div>
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <?php if (!empty($_SESSION['cart'])): ?>
                        <a href="/Sunstore-Project/checkout.php" class="btn btn-success w-100 py-2">
                            Proceed to Checkout
                        </a>
                    <?php endif; ?>
                </div>
