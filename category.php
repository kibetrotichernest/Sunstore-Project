        ...
        <div class="col-12">
            ...
            <div class="category-header bg-light p-4 rounded">
                ...
                <?php if(!empty($category['image'])): ?>
                    <img src="/sunstore-industries/admin/assets/categories/<?= $category['image'] ?>" class="img-fluid rounded mb-3" alt="<?= htmlspecialchars($category['name']) ?>" style="max-height: 300px;">
                <?php endif; ?>
            </div>
        </div>
    </div>
                ...
                <?php else: ?>
                    <div class="col-12">
                        <div class="alert alert-warning text-center">
                            ...
                            <p>Try browsing our <a href="products.php">other categories</a></p>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
