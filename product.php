            ...
            <div class="col-md-6">
                <div class="card mb-4 position-relative">
                    ...
                    <div class="product-main-image text-center p-3">
                        <img id="main-product-image" src="/sunstore-industries/admin/assets/products/<?= htmlspecialchars($product['image']) ?>" 
                    ...
                    <div class="product-thumbnails mt-3 p-3">
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="thumbnail-item">
                                <img src="/sunstore-industries/admin/assets/products/<?= htmlspecialchars($product['image']) ?>" 
                            ...
                            <div class="thumbnail-item">
                                <img src="/sunstore-industries/admin/assets/products/<?= htmlspecialchars($image) ?>" 
                ...
                <?php foreach ($related_products as $related): ?>
                    <div class="col-md-3 mb-4">
                        <div class="card product-card h-100">
                            ...
                            <img src="/sunstore-industries/admin/assets/products/<?= $related['image'] ?>" 
                ...
                <?php foreach ($all_products as $product): ?>
                    <div class="col-md-4 mb-4">
                        <div class="card product-card h-100">
                            ...
                            <img src="/sunstore-industries/admin/assets/products/<?= $product['image'] ?>" 
