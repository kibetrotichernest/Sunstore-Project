...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if ($stmt->execute()) {
            ...
            // Set session variables (standardized)
            ...
            header("Location: customers/customer_account.php");
            exit();
        } else {
            ...
            <div class="col-md-8 col-lg-6">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <?php else: ?>
                            <form method="POST" action="/Sunstore-Project/customer_register.php">
                                <div class="row mb-3">
                                    <div class="col-md-6">
                        ...
                        <div class="mt-3 text-center">
                            <p>Already have an account? <a href="/Sunstore-Project/customer_login.php">Sign in</a></p>
                        </div>
                    </div>
                </div>
            </div>
