...
$isLoggedIn = isset($_SESSION['customer_id']) && $_SESSION['logged_in'] === true;
...
<head>
    ...
    <link rel="stylesheet" href="/sunstore-industries/assets/css/style.css">
</head>
<body>
    <!-- Top Navigation Bar -->
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-end">
                    <?php if($isLoggedIn): ?>
                        ...
                        <a href="/sunstore-industries/customers/customer_account.php" class="text-white text-decoration-none me-3">My Account</a>
                        <a href="/sunstore-industries/track_orders.php" class="text-white text-decoration-none me-3">My Orders</a>
                        <a href="/sunstore-industries/blogs.php" class="text-white text-decoration-none me-3">Blogs</a>
                        <a href="/sunstore-industries/about.php" class="text-white text-decoration-none me-3">About Us</a>
                    <?php else: ?>
                        <a href="/sunstore-industries/about.php" class="text-white text-decoration-none me-3">About Us</a>
                        <a href="/sunstore-industries/contact.php" class="text-white text-decoration-none me-3">Contact Us</a>
                         <a href="/sunstore-industries/blogs.php" class="text-white text-decoration-none me-3">Blogs</a>
                    <?php endif; ?>
...
@media (max-width: 576px) {
    ...
    <nav class="navbar navbar-expand-lg navbar-light py-3 sticky-top shadow-sm" style="background: linear-gradient(90deg, #997346, #f2c987);">
        <div class="container">
<a class="navbar-brand" href="/sunstore-industries/index.php">
    <img src="/sunstore-industries/assets/images/logo.png" 
         ...
         class="responsive-logo">
            ...
            <div class="d-flex align-items-center">
                <?php if($isLoggedIn): ?>
                    <div class="dropdown me-3">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="accountDropdown">
                            <li><a class="dropdown-item" href="/sunstore-industries/customers/customer_account.php">
                                <i class="fas fa-user me-2"></i> Profile
                            </a></li>
                            <li><a class="dropdown-item" href="/sunstore-industries/customers/orders.php">
                                <i class="fas fa-box-open me-2"></i> My Orders
                            </a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li>
                                <a class="dropdown-item text-danger" href="/sunstore-industries/customer_logout.php">
                ...
                <?php else: ?>
                    <a href="/sunstore-industries/customer_login.php" class="btn btn-outline-primary me-3">
                        <i class="fas fa-sign-in-alt me-1"></i> Login/Register
                    </a>
                <?php endif; ?>
                
                <a href="/sunstore-industries/cart.php" class="btn btn-outline-primary position-relative">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="departmentDropdown">
                    ...
                    foreach($categories as $category) {
                        echo '<li><a class="dropdown-item" href="/sunstore-industries/product.php?id='.$category['id'].'">'.htmlspecialchars($category['name']).'</a></li>';
                    }
                    ?>
                </ul>
            </div>
