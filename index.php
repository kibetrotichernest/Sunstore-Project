                            ...
                            <div class="col-md-6 mb-4">
                                <div class="project-card h-100 shadow-sm rounded overflow-hidden">
                                    <div class="recent-project-img-container p-3">
                                        <img src="/Sunstore-Project/admin/assets/projects/<?= $project['image'] ?>" class="img-fluid" alt="<?= htmlspecialchars($project['title']) ?>" loading="lazy">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (brandFilter) {
            brandFilter.addEventListener('change', function() {
                ...
                if (brandId === 'all') {
                    window.location.href = 'product.php?view=all';
                } else {
                    window.location.href = 'product.php?brand=' + encodeURIComponent(brandId);
                }
            });
        }
    });
